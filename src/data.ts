...
export const FEATURED_SITUATIONS: FeaturedSituation[] = [
  ...
  },
  {
    ...
    facilityIds: ["kaiyukan", "science-museum", "cinema", "karaoke-jankara", "kyoto-railway-museum"],
  },
  {
    id: "companion-free",
    title: "同伴者も割引になる施設",
    description: "友人・家族と一緒におトクに",
    facilityIds: ["usj", "kaiyukan", "cinema", "tennoji-zoo", "kobe-oji-zoo", "kyoto-nijo-castle"],
  },
  {
    id: "save-monthly",
    title: "毎月の固定費を減らしたい",
  ...
  },
  {
    id: "kansai-outing",
    title: "関西おでかけガイド",
    description: "大阪・神戸・京都の割引スポットを横断チェック",
    facilityIds: [
      "kobe-oji-zoo",
      "kobe-suma-seaworld",
      "kyoto-nijo-castle",
  ...
  },
  {
    id: "parking-deals",
    title: "駐車場の割引を探す",
    description: "市営駐車場の障害者割引まとめ",
    facilityIds: [
      "kobe-sannomiya-parking",
      "kobe-meriken-parking",
      "kyoto-cityhall-parking",
      "kyoto-okazaki-parking",
    ],
  },
];
...
export const MOCK_FACILITIES: Facility[] = [
  ...
  // ── 神戸市 ──
  {
    ...
    location: "神戸市灘区",
    notes: "手帳提示（身体・療育・精神）。ミライロID対応。",
  },
  {
    id: "kobe-suma-seaworld",
    name: "神戸須磨シーワールド",
    category: "entertainment",
    subcategory: "水族館",
    discount: {
      physical: { g1: "半額", g2: "対象外", g3: "対象外" },
      intellectual: { g1: "半額", g2: "対象外", g3: "対象外" },
      mental: { g1: "半額", g2: "対象外", g3: "対象外" },
    },
    caregiver: "重度の場合、介護者1名も半額",
    accessibility: {
      wheelchairParking: true,
      multiPurposeToilet: true,
      elevator: true,
    ...
    location: "神戸市須磨区",
    notes: "1級・A判定等の重度、または車椅子利用者が対象。ミライロID対応。",
  },
  {
    id: "kobe-maya-viewline",
    name: "まやビューライン（摩耶ロープウェー）",
    category: "entertainment",
    subcategory: "アトラクション",
    discount: {
      physical: { g1: "半額（本人+介護者）", g2: "半額（本人のみ）", g3: "半額（本人のみ）" },
      intellectual: { g1: "半額（本人+介護者）", g2: "半額（本人のみ）", g3: "半額（本人のみ）" },
      mental: { g1: "半額（本人+介護者）", g2: "半額（本人のみ）", g3: "半額（本人のみ）" },
    },
    caregiver: "第1種は介護者1名も半額",
    accessibility: {},
    location: "神戸市灘区",
    notes: "精神障害者保健福祉手帳も対象。",
  },
  {
    id: "kobe-sannomiya-parking",
    name: "神戸市営三宮駐車場",
    category: "mobility",
    subcategory: "駐車場",
    discount: {
      physical: { g1: "3時間無料", g2: "3時間無料", g3: "3時間無料" },
      intellectual: { g1: "3時間無料", g2: "3時間無料", g3: "3時間無料" },
      mental: { g1: "3時間無料", g2: "3時間無料", g3: "3時間無料" },
    },
    accessibility: { wheelchairParking: true },
    location: "神戸市中央区",
    notes: "精算前に管理事務所またはインターホンで認証が必要。手帳所持者が運転または同乗。",
  },
  {
    id: "kobe-meriken-parking",
    name: "メリケンパーク駐車場",
    category: "mobility",
    subcategory: "駐車場",
    discount: {
  ...
  },
  {
    ...
    subcategory: "公共交通",
    discount: {
      physical: { g1: "5割引＋介護者割引", g2: "5割引", g3: "5割引" },
      intellectual: { g1: "5割引＋介護者割引", g2: "5割引", g3: "5割引" },
      mental: { g1: "5割引＋介護者割引", g2: "5割引", g3: "5割引" },
    },
    caregiver: "第1種の場合、介護者も50%割引",
    accessibility: {
      wheelchairParking: true,
      elevator: true,
      multiPurposeToilet: true,
    ...
    location: "神戸市",
    notes: "神戸市民向けには無料の『福祉乗車証』制度あり。普通券のみ対象。",
  },
  ...
  },
  {
    ...
    accessibility: { wheelchairParking: true },
    location: "京都市中京区",
    notes: "24時間営業、地下機械式。全等級対象。",
  },
  {
    id: "kyoto-okazaki-parking",
    name: "岡崎公園駐車場",
    category: "mobility",
    subcategory: "駐車場",
    discount: {
  ...
  },
  {
    ...
    subcategory: "公共交通",
    discount: {
      physical: { g1: "5割引＋介護者無料", g2: "5割引", g3: "5割引" },
      intellectual: { g1: "5割引＋介護者無料", g2: "5割引", g3: "5割引" },
      mental: { g1: "5割引＋介護者無料", g2: "5割引", g3: "5割引" },
    },
    caregiver: "第1種・A判定・精神1級は介護者1名無料/割引",
    accessibility: {
      wheelchairParking: true,
      elevator: true,
      multiPurposeToilet: true,
    ...
    location: "京都市",
    notes: "京都市在住者には『福祉乗車証（無料パス）』が交付される。",
  },
];
